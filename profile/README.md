...
- **Software**: We've built Scenario Builder, our free no-code platform for power systems modelling: [**Scenario Builder**)](https://www.transitionzero.org/products/scenario-builder). Scenario Builder allows modellers to create long-term capacity expansion and short-term hourly dispatch models for a wide range of countries in a no-code interface to inform energy transition decision-making. We've also built our version of the popular OSeMOSYS framework for long-term capacity expansion modelling: [**TZ-OSeMOSYS**](https://github.com/transition-zero/tz-osemosys/). 
...
We are a small team of data scientists, engineers and modellers headquartered at Sustainable Ventures in London, UK.
